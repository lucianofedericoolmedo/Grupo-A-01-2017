...
public class CSVFileParser {
	...
	public static <BuildingType extends BasicStructure> List<BuildingType> parseCSVFile(InputStream is, CsvResultAbstractBuilder<BuildingType> builder) throws FileNotFoundException {
